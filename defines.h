...
const char* ssid = "TELUS0800"; //Enter SSID
const char* password = "6chvt42zv3"; //Enter Password

// Deprecated echo.websocket.org to be replaced or it won't work
const char* websockets_connection_string = "wss://coinos.io/ws"; //Enter server adress
